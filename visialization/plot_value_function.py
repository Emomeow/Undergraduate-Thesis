...
def plot_current_value_function(value_function_list, state_size, gradient_type):
    ...
    plt.savefig(CURRENT_PATH + "/../img/" + gradient_type + "_value_function_for_each_state.png", bbox_inches='tight', pad_inches=1)
    plt.close()
...
def plot_state_action_value_function(state_action_value_function_list, state_size, action_size, gradient_type):
    ...
    plt.savefig(CURRENT_PATH + "/../img/" + gradient_type + "_value_function_for_each_state_action.png", bbox_inches='tight', pad_inches=1)
    plt.close()
    ...
    plt.savefig(CURRENT_PATH + "/../img/" + gradient_type + "_value_function_for_each_state_action_subplot.png",
