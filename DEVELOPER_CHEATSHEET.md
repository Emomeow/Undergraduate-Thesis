...
1) Top-level runner
- File: `main_func.py` — def `main_func(...)` at line 40 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/main_func.py#L40)
...
2) Agent and training
-- File: `agent/agent.py` — `class MDPAgent` at line 21 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/agent.py#L21)
...
-- File: `agent/nn_model.py` — `class FCNN` at line 16 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/nn_model.py#L16)

4) Training routines (semi / true gradient)
-- File: `agent/model_operation.py` — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_operation.py)
  - `training_fcnn_model_with_semi_gradient(...)` at line 15 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_operation.py#L15)
  - `training_fcnn_model_with_true_gradient(...)` at line 115 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_operation.py#L115)
  - Typical edits: change batching, loss computation, or optimizer scheduling here.

5) Loss-computation helpers
-- File: `agent/model_compute_loss.py` — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_compute_loss.py)
  - `loss_with_semi_gradient(...)` at line 11 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_compute_loss.py#L11)
  - `loss_with_true_gradient(...)` at line 100 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/model_compute_loss.py#L100)
...
-- File: `agent/replay_buffer.py` — `class SimpleReplayBuffer` at line 7 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/agent/replay_buffer.py#L7)
...
-- File: `rl_enviroment/env_simple.py` — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/rl_enviroment/env_simple.py)
  - `def render(self, mode='human', close=False, policy_list=None):` at line 222 — drawing/rendering code (pygame + matplotlib fallback logic lives in visualizer). [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/rl_enviroment/env_simple.py#L222)
  - `def get_state_action_next_state_tuple(self):` at line 330 — returns the (s, a, s', r, done)-style tuples used to populate the replay buffer. [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/rl_enviroment/env_simple.py#L330)
...
-- File: `visialization/plot_accumulate_reward.py` — `plt_accumulate_reward(...)` at line 11 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/visialization/plot_accumulate_reward.py#L11)
-- File: `visialization/plot_loss.py` — `plot_loss(...)` at line 13 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/visialization/plot_loss.py#L13)
-- File: `visialization/plot_policies.py` — `plot_policy_in_env(...)` at line 10 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/visialization/plot_policies.py#L10)
-- File: `visialization/plot_value_function.py` — `plot_current_value_function(...)` at line 18 and `plot_state_action_value_function(...)` at line 37 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/visialization/plot_value_function.py#L18)
-- File: `visialization/plot_value_change.py` — `plot_value_change(...)` at line 41 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/visialization/plot_value_change.py#L41)
...
-- File: `config.py` — `DEVICE = torch.device("cuda:0" if USE_CUDA else "cpu")` at line 13 — [open on GitHub](https://github.com/<OWNER>/<REPO>/blob/<BRANCH>/config.py#L13)
